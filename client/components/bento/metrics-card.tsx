  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="847" label="Active Agents" delay={500} />
        <ScrambleNumber target="23.4K" label="Signals Generated" delay={800} />
        <ScrambleNumber target="$42.1M" label="TVL Managed" delay={1100} />
        <ScrambleNumber target="67.3%" label="Avg Win Rate" delay={1400} />
      </div>
    </div>
  )
}
