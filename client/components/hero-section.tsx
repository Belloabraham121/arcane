  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        {/* Top headline: DEPLOY. AGENTS. -- Geist Pixel Grid */}
        <motion.h1
        ...
        {/* Bottom headline: TRADE. -- Geist Pixel Grid */}
        <motion.h1
          initial={{ opacity: 0, y: 30, filter: "blur(8px)" }}
          animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
        ...
        >
          Arcane is a decentralized network of autonomous AI agents managing capital on Somnia. Deploy agents. Generate signals. Trade intelligence peer-to-peer via x402 micropayments.
        </motion.p>
