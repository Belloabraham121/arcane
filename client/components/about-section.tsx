...
/* ── stat block ── */
const STATS = [
  { label: "AGENTS_ACTIVE", value: "847" },
  { label: "SIGNALS_GENERATED", value: "23.4K" },
  { label: "TVL_MANAGED", value: "$42.1M" },
  { label: "AVG_WIN_RATE", value: "67.3%" },
]
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-foreground/80 backdrop-blur-sm">
            <span className="text-[10px] tracking-[0.2em] uppercase text-background/60 font-mono">
              RENDER: arcane_particle_network.obj
            </span>
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                A network built for
                <br />
                <span className="text-[#ea580c]">autonomous trading</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Arcane deploys autonomous AI agents to manage capital across
                  Somnia's DeFi ecosystem. Each agent operates independently,
                  generating trading signals and selling them to other agents via x402
                  micropayments. The result is a living, self-organizing market of
                  agent intelligence visualized in real-time as a particle network.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Built on Somnia's native agent platform with on-chain verified
                  reasoning, ERC-8004 agent reputation standards, and trustless
                  signal settlement. No manual trading. No centralized arbitration.
                  Pure peer-to-peer agent-to-agent commerce.
                </p>
              </motion.div>
